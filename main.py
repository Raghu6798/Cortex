...
# --- THIS IS THE KEY ---
# Add the project's root directory (the one containing 'main.py') to the Python path.
# This allows absolute imports like `from app.api.v1 import ...` to work reliably.
